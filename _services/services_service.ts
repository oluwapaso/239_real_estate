                    ...
                    try{
                        ...
                        if(isSlugAvailable < 1){
                            ...
                            if(files.file?.length){
                                ...
                                if (old_header_image_loc && old_header_image_loc != "" && old_header_image_loc != fileUrl) {
                                    await this.helpers.deleteS3Image(old_header_image_loc);
                                }
                        ...
                        if(isSlugAvailable < 1){
                            ...
                            if(files.file?.length){
                                ...
                                if (submit_type == "Publish") {
                                    ...
                                    if (pub_image_loc != "") {
                                        await this.helpers.deleteS3Image(pub_image_loc);
                                    }
