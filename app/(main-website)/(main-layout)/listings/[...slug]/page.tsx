        ...
        <>
                            ...
                            <div className='w-full grid grid-cols-1 lg:grid-cols-6 gap-8'>
                                ...
                                <div className='lg:col-span-4'>
                                    ...
                                    <div className="section w-full" id='about'>
                                        ...
                                        <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-3 mt-5'>
                                            ...
                                            <div className='py-4 px-4 bg-gray-50 flex items-center'>
                                                ...
                                                <span>{prop.full_info.PricePerSqFt ? numeral(prop.full_info.PricePerSqFt).format("$0,0") : "--"} sqft</span>
                                            </div>

                                            <div className='py-4 px-4 bg-gray-50 items-center !hidden'>
                                                <div className='mr-2'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 30 30">
                                    ...
                                    <div className='w-full mt-14' id='community'>
                                        ...
                                        <div className='w-full mt-4 grid grid-cols-1 xs:grid-cols-2 gap-x-6 *:py-4 *:border-b *:border-gray-300'>
                                            ...
                                            <div className='flex justify-between'>
                                                ...
                                                <div className='font-normal text-base text-right'>{prop.full_info.Development}</div>
                                            </div>
                                    ...
                                    <div className={`w-full mt-14 ${((prop.Amenities && prop.Amenities != "")
                                        || (prop.full_info.Equipment && prop.full_info.Equipment != "")
                                        || (prop.full_info.PrivatePoolDesc && prop.full_info.PrivatePoolDesc != "")
                                        || (prop.full_info.PrivateSpaDesc && prop.full_info.PrivateSpaDesc != "")) ? "block" : "hidden"
                                        }`} id='amenities'>
                                        ...
                                        <div className='w-full mt-4 *:py-4 *:border-b *:border-gray-300'>
                                            ...
                                            {
                                                (prop.full_info.Equipment && prop.full_info.Equipment != "") && <div className='w-full col-span-2 flex items-center flex-wrap !border-transparent'>
                                                    <div className='w-full font-semibold text-base'>Equipment</div>
                                                    {
                                                        prop.full_info.Equipment.split(",").map((utility: any, index: number) => {
                                                            return <div key={index} className='flex mr-2 mb-2 rounded items-center 
                                                            justify-center bg-gray-100 text-primary px-4 py-2 cursor-pointer 
                                            ...
                                            {
                                                (prop.full_info.PrivatePoolDesc && prop.full_info.PrivatePoolDesc != "") && <div className='w-full col-span-2 flex items-center flex-wrap !border-transparent'>
                                                    <div className='w-full font-semibold text-base'>Private Pool Description</div>
                                                    {
                                                        prop.full_info.PrivatePoolDesc.split(",").map((garage: any, index: number) => {
                                                            return <div key={index} className='flex mr-2 mb-2 rounded items-center 
                                                            justify-center bg-gray-100 text-primary px-4 py-2 cursor-pointer 
                                            ...
                                            {
                                                (prop.full_info.PrivateSpaDesc && prop.full_info.PrivateSpaDesc != "") && <div className='w-full col-span-2 flex items-center flex-wrap !border-transparent'>
                                                    <div className='w-full font-semibold text-base'>Private Spa Description</div>
                                                    {
                                                        prop.full_info.PrivateSpaDesc.split(",").map((garage: any, index: number) => {
                                                            return <div key={index} className='flex mr-2 mb-2 rounded items-center 
                                                            justify-center bg-gray-100 text-primary px-4 py-2 cursor-pointer 
                                                            hover:drop-shadow-lg'>{garage}</div>
                                                        })
                                    ...
                                    <div className={`w-full mt-14 ${((prop.full_info.InteriorFeatures && prop.full_info.InteriorFeatures != "")
                                        || (prop.full_info.Flooring && prop.full_info.Flooring != "")
                                        || (prop.full_info.Cooling && prop.full_info.Cooling != "")
                                        || (prop.full_info.Heat && prop.full_info.Heat != "")) ? "block" : "hidden"
                                        }`} id='interior'>
                                        <h1 className='w-full font-play-fair-display text-3xl md:text-4xl'>Interior</h1>
                                        <div className='w-full mt-4 *:py-4 *:border-b *:border-gray-300'>

                                            {
                                                (prop.full_info.InteriorFeatures && prop.full_info.InteriorFeatures != "") && <div className='w-full col-span-2 flex items-center flex-wrap !border-transparent'>
                                                    <div className='w-full font-semibold text-base'>Interior Features</div>
                                                    {
                                                        prop.full_info.InteriorFeatures.split(",").map((interior: any, index: number) => {
                                                            return <div key={index} className='flex mr-2 mb-2 rounded items-center 
                                                            justify-center bg-gray-100 text-primary px-4 py-2 cursor-pointer 
                                            ...
                                            {
                                                (prop.full_info.Flooring && prop.full_info.Flooring != "") && <div className='w-full col-span-2 flex items-center flex-wrap !border-transparent'>
                                                    <div className='w-full font-semibold text-base'>Flooring</div>
                                                    {
                                                        prop.full_info.Flooring.split(",").map((heating: any, index: number) => {
                                                            return <div key={index} className='flex mr-2 mb-2 rounded items-center 
                                                            justify-center bg-gray-100 text-primary px-4 py-2 cursor-pointer 
                                            ...
                                            {
                                                (prop.full_info.Cooling && prop.full_info.Cooling != "") && <div className='w-full col-span-2 flex items-center flex-wrap !border-transparent'>
                                                    <div className='w-full font-semibold text-base'>Cooling</div>
                                                    {
                                                        prop.full_info.Cooling.split(",").map((app: any, index: number) => {
                                                            return <div key={index} className='flex mr-2 mb-2 rounded items-center 
                                                            justify-center bg-gray-100 text-primary px-4 py-2 cursor-pointer 
                                            ...
                                            {
                                                (prop.full_info.Heat && prop.full_info.Heat != "") && <div className='w-full col-span-2 flex items-center flex-wrap !border-transparent'>
                                                    <div className='w-full font-semibold text-base'>Heat</div>
                                                    {
                                                        prop.full_info.Heat.split(",").map((app: any, index: number) => {
                                                            return <div key={index} className='flex mr-2 mb-2 rounded items-center 
                                                            justify-center bg-gray-100 text-primary px-4 py-2 cursor-pointer 
                                                            hover:drop-shadow-lg'>{app}</div>
                                                        })
                                    ...
                                    <div className={`w-full mt-14 ${((prop.full_info.ExteriorFeatures && prop.full_info.ExteriorFeatures != "")
                                        || (prop.full_info.ExteriorFinish && prop.full_info.ExteriorFinish != "")
                                        || (prop.full_info.StormProtection && prop.full_info.StormProtection != "")
                                        || (prop.View && prop.View != ""))
                                        ? "block" : "hidden"}`} id='exterior'>
                                        <h1 className='w-full font-play-fair-display text-3xl md:text-4xl'>Exterior</h1>
                                        <div className='w-full mt-4 *:py-4 *:border-b *:border-gray-300'>
                                            <PropFeatures title="Exterior Features" features={prop.full_info.ExteriorFeatures} />
                                            <PropFeatures title="View" features={prop.View} />
                                            <PropFeatures title="Exterior Finish" features={prop.full_info.ExteriorFinish} />
                                            <PropFeatures title="Storm Protection" features={prop.full_info.StormProtection} />
                                        </div>
                                    </div>

                                    <div className={`w-full mt-14 ${((prop.full_info.Pets && prop.full_info.Pets != "")
                                        || (prop.full_info.PetsLimitMaxNumber && prop.full_info.PetsLimitMaxNumber != "")
                                        || (prop.full_info.PetLimitBreed && prop.full_info.PetLimitBreed != "")
                                        || (prop.full_info.PetDepositFee && prop.full_info.PetDepositFee != "")
                                        || (prop.full_info.PetDepositDesc && prop.full_info.PetDepositDesc != "")) ? "block" : "hidden"
                                        }`} id='schools'>
                                        ...
                                        <div className='w-full mt-4 grid grid-cols-1 sm:grid-cols-2 gap-x-6 *:py-4 *:border-b *:border-gray-300'>
                                            {
                                                (prop.full_info.Pets && prop.full_info.Pets != "") &&
                                                <div className='flex justify-between'>
                                                    <div className='font-semibold text-base'>Pets</div>
                                                    <div className='font-normal text-base text-right'>{prop.full_info.Pets}</div>
                                                </div>
                                            }

                                            {
                                                ...
                                                <div className='flex justify-between'>
                                                    ...
                                                    <div className='font-normal text-base text-right'>{prop.full_info.PetsLimitMaxNumber}</div>
                                                </div>
                                            }

                                            {
                                                ...
                                                <div className='flex justify-between'>
                                                    ...
                                                    <div className='font-normal text-base text-right'>{prop.full_info.PetLimitBreed}</div>
                                                </div>
                                            }

                                            {
                                                ...
                                                <div className='flex justify-between'>
                                                    ...
                                                    <div className='font-normal text-base text-right'>{prop.full_info.PetDepositFee}</div>
                                                </div>
                                            }

                                            {
                                                (prop.full_info.PetDepositDesc && prop.full_info.PetDepositDesc != "") &&
                                                <div className='flex justify-between'>
                                                    <div className='font-semibold text-base'>Pet Deposit Description</div>
                                                    <div className='font-normal text-base text-right'>{prop.full_info.PetDepositDesc}</div>
                                                </div>
                                            }
                                        </div>
                                    </div>

                                    <div className={`w-full mt-14 ${((prop.full_info.ElementarySchool && prop.full_info.ElementarySchool != "")
                                        || (prop.full_info.HighSchool && prop.full_info.HighSchool != "")
                                        || (prop.full_info.MiddleSchool && prop.full_info.MiddleSchool != "")) ? "block" : "hidden"
                                        }`} id='schools'>
                                        <h1 className='w-full font-play-fair-display text-3xl md:text-4xl'>Schools</h1>
                                        <div className='w-full mt-4 grid grid-cols-1 sm:grid-cols-2 gap-x-6 *:py-4 *:border-b *:border-gray-300'>
                                            {
                                                (prop.full_info.ElementarySchool && prop.full_info.ElementarySchool != "") &&
                                                <div className='flex justify-between'>
                                                    <div className='font-semibold text-base'>Elementary School</div>
                                                    <div className='font-normal text-base text-right'>{prop.full_info.ElementarySchool}</div>
                                                </div>
                                            }

                                            {
                                                ...
                                                <div className='flex justify-between'>
                                                    ...
                                                    <div className='font-normal text-base text-right'>{prop.full_info.HighSchool}</div>
                                                </div>
                                            }

                                            {
                                                (prop.full_info.MiddleSchool && prop.full_info.MiddleSchool != "") &&
                                                <div className='flex justify-between'>
                                                    <div className='font-semibold text-base'>Middle School</div>
                                                    <div className='font-normal text-base text-right'>{prop.full_info.MiddleSchool}</div>
                                                </div>
                                            }
                                        </div>
                                    </div>

                                    <div className={`w-full mt-14 ${((prop.full_info.Restrictions && prop.full_info.Restrictions != "")) ? "block" : "hidden"
                                        }`} id='interior'>
                                        <h1 className='w-full font-play-fair-display text-3xl md:text-4xl'>Additional Information</h1>
                                        <div className='w-full mt-4 *:py-4 *:border-b *:border-gray-300'>

                                            {
                                                (prop.full_info.Restrictions && prop.full_info.Restrictions != "") && <div className='w-full col-span-2 flex items-center flex-wrap !border-transparent'>
                                                    <div className='w-full font-semibold text-base'>Restrictions</div>
                                                    {
                                                        prop.full_info.Restrictions.split(",").map((interior: any, index: number) => {
                                                            return <div key={index} className='flex mr-2 mb-2 rounded items-center 
                                                            justify-center bg-gray-100 text-primary px-4 py-2 cursor-pointer 
                                                            hover:drop-shadow-lg'>{interior}</div>
                                                        })
...

            {
                (!isLoadingInfo && page_error && page_error != "") && (
                    <div className='w-full bg-red-100 text-red-600 hidden justify-center items-center min-h-80'>
                        {page_error}
                    </div>
                )
            }
