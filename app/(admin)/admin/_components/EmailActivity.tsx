...
const EmailActivity = ({ activity, index, activities_len }: { activity: any, index: number, activities_len: number }) => {

    let msg_type = activity.type;
    if (msg_type == "CRM Message") {
        msg_type = "You contacted user";
    } else if (msg_type == "Enquiry") {
        msg_type = "Enquiry Auto Responder";
    } else if (msg_type == "Tour Request") {
        msg_type = "Tour Request Auto Responder";
    } else if (msg_type == "Showing Request") {
        msg_type = "Showing Request Auto Responder";
    } else if (msg_type == "Buying Request") {
        msg_type = "Buying Request Auto Responder";
    } else if (msg_type == "Selling Request") {
        msg_type = "Selling Request Auto Responder";
    }
        ...
        <li className="rounded-lg cursor-pointer">
            <div className="flex flex-row">
                <div className="items-center flex flex-col justify-around relative">
                    <div className="">
                        <div className='bg-green-500 size-12 rounded-full flex justify-center items-center'>
                ...
                <div className="flex flex-col group-hover:bg-gray-50 ml-4 pb-10 flex-grow w-full box-border">
                    ...
                    <div className="text-base"><span className='font-medium'>Subject:</span> <span>{activity.field_2}</span></div>
