...
const MoreServiceActions = ({ service_id, draft_id, slug, published, handleDelete }:
    { service_id: number, draft_id: number, slug: string, published: string, handleDelete: (draft_id: number) => Promise<void> }) => {
                    ...
                    <ul className='w-[140px] bg-white shadow-xl border border-gray-200 rounded absolute right-0 z-20 *:px-4 *:py-4 *:cursor-pointer
                     divide-y divide-gray-200'>
                        <li className='hover:bg-gray-50' onClick={() => {
                            ...
                            GoTo(`/admin/edit-service?draft_id=${draft_id}`);
                        }}>
                        ...
                        </li>
                        {
                            published == "Yes" && (
                                <>
                                    <li className='hover:bg-gray-50' onClick={() => openInNewTab(`/service/${slug}`)}>
                                        <div className='w-full flex items-center'>
...
export default MoreServiceActions