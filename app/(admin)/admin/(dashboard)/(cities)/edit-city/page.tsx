...
const EditCommunity = () => {
    ...
    useEffect(() => {
        ...
        const fetchDraftInfo = async () => {
            try {
                ...
                setHeaderIMage(data_info.draft_header_image);
    ...
    const handleSubmit = async (type: string) => {
        ...
        try {
            ...
            form_data.append("header_image", JSON.stringify(published_header_image));
            form_data.append("draft_header_image", JSON.stringify(header_image));
