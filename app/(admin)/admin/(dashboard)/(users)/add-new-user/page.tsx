...
const EditUserInfo = () => {
    ...
    return (
        <div className='w-full'>
            <PageTitle text="Add New User" show_back={true} />
                ...
                <div className='w-full mt-6'>
                    <div className='w-full grid grid-cols-1 lg:grid-cols-3 gap-4'>
                        ...
                        <div className='lg:col-span-1'>
                            ...
                            <div className=''>Fill the form to add new user. Fileds marked with asterisk are required</div>
                        </div>
                                    ...
                                    <div className='w-full grid grid-cols-1 sm:grid-cols-2 gap-4'>
                                        ...
                                        <div className='col-span-1 sm:col-span-1'>
                                            <label htmlFor="firstname" className='form-label flex items-center'>
                                                <span className='mr-1'>First Name</span> <FaAsterisk size={11} className='text-red-500' />
                                            </label>
                                        ...
                                        <div className='col-span-1 sm:col-span-1'>
                                            <label htmlFor="firstname" className='form-label flex items-center'>
                                                <span className='mr-1'>Last Name</span> <FaAsterisk size={11} className='text-red-500' />
                                            </label>
                                        ...
                                        <div className='col-span-1 sm:col-span-2 mt-3'>
                                            <button type="submit" className='bg-gray-800 py-2 px-6 rounded-md text-white float-right 
