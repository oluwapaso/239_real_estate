...
import { AddServiceParams, AddTemplateParams, GetSingleUserParams, LoadSingleTemplateParams, LoadTemplatesParams, SendMailParams, TemplateDetails, TemplateLists, UpdateTemplateParams } from "@/components/types";
