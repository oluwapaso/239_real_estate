                    ...
                    session?.user ? <div className='mr-5 group relative'>
                        ...
                        <div className='absolute hidden w-[220px] z-[200] bg-transparent group-hover:block pt-[24px] right-0'>
                            <ul className='nav-menu'>
                                ...
                                <li className='nav-menu-item cursor-pointer' onClick={() => signOut()}>
                        ...
                        : <div className='auth-container mr-5'>
                            <button className={`border-2 border-white ${signup_brdr} px-6 py-1 transition duration-300 
                            cursor-pointer ${btn_hover}`} onClick={handleLoginModal}>Sign In</button>
                        </div>
                }
                        ...
                        overflow-x-hidden overflow-y-auto font-normal *:bg-gray-800 *:rounded-md space-y-3' onClick={closeMenu}>
...

                            {
                                session?.user
                                    ...
                                    : <div onClick={handleLoginModal} className='cursor-pointer'>Sign In</div>
                            }
                        </div>
                    </div>
                </div>
